module Stixy
  ...
  class Calendar
    ...
    def previous view = :month
      case view.to_sym
      when :day then Date.civil(self.year,self.month,self.day) - 1
      when :week then Date.civil(self.year,self.month,self.day) - 7
      when :year then Date.civil(self.year-1, self.month, self.day)
