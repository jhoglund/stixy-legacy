var STIXY_FILE_GENERATED_AT = 'Mon Oct 26 13:29:09 +0100 2009';
var STIXY_ENV = 'test';
try {
...
Stixy.extend(Stixy, {
    ...
    this.open = function(uri,width,height,returnFunction){
      ...
      this.currentFrame.contentWindow.Stixy.JSON.replaceHTML({ replace: { popup_content:'' }});
