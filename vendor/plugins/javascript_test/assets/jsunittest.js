 ...
 *
 *  Updated by Jonas to work with Stixy library
 *  Reference at http://jsunittest.com/
 *
 *--------------------------------------------------------------------------*/
...
var JsUnitTest = {
  ...
  hashToSortedArray: function(hash) {
    var results = [];
    hash.eachProperty(function(key, value){
  ...
  /^:((first|last|nth|nth-last|only)(-child|-of-type)|empty|checked|(en|dis)abled|not)(\((.*?)\))?(\b|$|(?=\s|[:+~>]))/,
    ...
    while (e && le !== e && (/\S/).test(e)) {
      le = e;
      ps.eachProperty(function(i, value){
        p = value;
        if (m = e.match(p)) {
...
JsUnitTest.Event.handleEvent = function(event) {
	...
	handlers.eachProperty(function(i, value){
...
JsUnitTest.Unit.Runner.prototype.getTests = function(testcases) {
  ...
  if (this.queryParams.tests) tests = this.queryParams.tests.split(',');
    ...
    testcases.eachProperty(function(testname, value){
...
JsUnitTest.Unit.Assertions.eachProperty(function(method, value){
